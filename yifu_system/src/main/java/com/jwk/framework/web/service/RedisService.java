...
public interface RedisService {
     ...
     */
    Boolean hxists(String hKey, String hashKey);
     ...
     */
    Object hGet(String hKey, String hashKey);
     ...
     */
    Long hIncrementLong(String hKey, String hashKey, Long delta);
     ...
     * @return 执行 HINCRBY 命令之后，哈希表 hKey 中域 hashKey 的值。
     */
    Double hIncrementDouble(String hKey, String hashKey, Double delta);
     ...
     * @param key
     */
    void rPushAll(String key, String... value);
     ...
     * @param value
     */
    Long lRem(String key, long i, Object value);
