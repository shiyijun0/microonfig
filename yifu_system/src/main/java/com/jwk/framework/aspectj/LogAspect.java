package com.jwk.framework.aspectj;
...
import com.jwk.project.monitor.operlog.service.IOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.jwk.framework.aspectj.lang.annotation.Log)")
