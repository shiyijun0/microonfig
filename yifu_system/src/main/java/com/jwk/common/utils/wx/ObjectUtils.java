...
//            排序过滤掉secretKey
     ...
     */
    public static String signatureGenerator(Map<String, Object> sortedMap, String encryptType, String charset, String key) throws ClientAbortException {
        String origin = getParamStr(sortedMap, key);
        if ((MD5).equalsIgnoreCase(encryptType)) {
            return md5Encrypt(origin, charset);
        }
        throw new ClientAbortException("only MD5 is supported");
     ...
     * @param <M> a M object.
     */
    public static <M extends Map<String, Object>> void verifySignature(M m, String encryptType, String secretKey) throws ClientAbortException {
        ...
        if (!originSign.equals(sign)) {
            throw new ClientAbortException("signature verification failed");
        }
    }
     ...
     * @throws cn.felord.wepay.common.exception.PayException the pay exception
     */
    public static <T> void checkParams(T t, List<String> fieldNames) throws ClientAbortException {
        ...
        try {
            ...
            for (PropertyDescriptor property : propertyDescriptors) {
                ...
                if (fieldNameSet.contains(key)) {
                    ...
                    Object value = getter.invoke(t);
                    if (value == null || "".equals(value)) {
                        throw new ClientAbortException(t.getClass().getName() + "  field [" + key + "] is null");
                    }
                }
            }
        } catch (IntrospectionException | IllegalAccessException | InvocationTargetException e) {
