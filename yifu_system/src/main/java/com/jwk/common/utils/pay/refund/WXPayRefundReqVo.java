 ...
 * 微信支付退款请求参数
 */
public class WXPayRefundReqVo implements Serializable {
	 ...
	 *            退款金额
	 */
	public WXPayRefundReqVo(String out_trade_no, int total_fee, int refund_fee) {
	 ...
	 *            退款金额
	 */
	public WXPayRefundReqVo(String out_trade_no, String out_refund_no, int total_fee, int refund_fee) {
	 ...
	 *            退款金额
	 */
	public WXPayRefundReqVo(String transaction_id, String out_trade_no, String out_refund_no, int total_fee,
			int refund_fee) {
		...
		this.op_user_id = WXPayConfig.MCH_ID;

		this.appid = WXPayConfig.APP_ID;
		this.mch_id = WXPayConfig.MCH_ID;
		this.nonce_str = RandomStringGenerator.getRandomStringByLength(32);
		// 根据API给的签名规则进行签名
		this.sign = WXSign.getSign(MapUtil.objectToMap(WXPayRefundReqVo.class, this));
	}
