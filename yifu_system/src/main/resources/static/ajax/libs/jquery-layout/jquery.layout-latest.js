...
,	_initContainer = function () {
		...
		if (!$N.data(css)) {
			...
			if (sC.isBody) {
				...
				// ALSO SAVE <html lang="zh_CN" xmlns:th="http://www.thymeleaf.org"> CSS
...
,	destroy = function (evt_or_destroyChildren, destroyChildren) {
		...
		// for full-page layouts, also reset the <html lang="zh_CN" xmlns:th="http://www.thymeleaf.org"> CSS
		if (sC.tagName === "BODY" && ($N = $("html")).data(css)) // RESET <html lang="zh_CN" xmlns:th="http://www.thymeleaf.org"> CSS
			$N.css( $N.data(css) ).removeData(css);
