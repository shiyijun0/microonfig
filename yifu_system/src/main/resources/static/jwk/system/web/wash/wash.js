	...
	var columns = [{
        ...
        },
        {
            ...
            formatter: function(value, row, index) {
                if (value != "") {
                	return '<img src="' + qiniuUrl + value + '" alt="破洞图片" width="62" height="52">'
                }
            }
        },
        
        {
            ...
            formatter: function(value, row, index) {
        		if (value != "") {
                	return '<img src="' + qiniuUrl + value + '" alt="破洞小图片" width="62" height="52">'
                }
            }
        },
...
// 单条删除
function remove(id) {
	$.modalConfirm("确定要删除选中该样式破洞吗？", function(r) {
