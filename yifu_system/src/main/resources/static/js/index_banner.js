...
$(window).resize(function(){
    $(".slide").height($(".slide").width()*1.7142857142857142);
});
...
$(function(){
    ...
    $(".slide .img").click(function() {
        var imgHref = $(this).find("img").attr('data-href');
        var imgHref1 = $(".slide .img3").find("img").attr('data-href')
        if(imgHref == imgHref1){
...
//修改当前最中间图片对应按钮选中状态
function slideLi(){
    var imgHref = $(".img3").find("img").attr('data-href');
    var imgTit = $(".img3").find("img").attr('data-title');
    $(".logo_tit").text(imgTit)
    var slideList = parseInt($(".slide .img3").attr("data-slide-imgId")) + 1;
    $(".slide-bt span").removeClass("on");
    $(".slide-bt span[data-slide-bt="+slideList+"]").addClass("on");

    $(".slide .img").css('opacity', '0.4');
